...
public class JwtTokenUtil implements Serializable {
    ...
    private ase.security.jwt.JwtConfigProperties jwtConfigProperties;

    public JwtTokenUtil(ase.security.jwt.JwtConfigProperties jwtConfigProperties) {
